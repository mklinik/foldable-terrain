...
\newcommand\buildingHeight{7.62cm} % must be wallHeight + coverHeight
\newcommand\buildingWidth{17.78cm}
\newcommand\buildingDepth{9.65cm}
...
\begin{scope}[yshift=-\buildingHeight + 0.5cm,xshift=-0.5cm]
